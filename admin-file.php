...
<link href="<?php echo plugins_url( 'css/style.css' , __FILE__ ); ?>" rel="stylesheet" type="text/css">
 <div class="wrap">
   <div class="top">
  <h3> <?php _e( "FB Comments Plugin", "facebook-comment-by-vivacity" ) ?> <small><?php _e("by","facebook-comment-by-vivacity") ?> <a href="http://www.vivacityinfotech.net" target="_blank">Vivacity Infotech Pvt. Ltd.</a>
  </h3>
    </div> <!-- ------End of top-----------  -->
...
<!-- ------End Post type Settings--------- -->		
		...
		<tr>
								...
								<small> - <?php _e( 'For exclude FB comment box, please enter page/post ids separate them with commas, like 5, 21', 'facebook-comment-by-vivacity' ); ?> </small></label>
								</th>
